...
def get_user_classes(user_email):
    ...
    [{'class_name': "Madhav's History Class", 'classid': 'gipn3bcspn5wphm'},
...
def get_more_info_classes(user_email):
    ...
    [{'class_name': "Madhav's History Class", 'classid': 'gipn3bcspn5wphm', 'class_standard':'10 B'} , {'class_name': "Madhav's Maths Class", 'classid': 'mngfdhr54hjuyd6' , 'class_standard : '11 D'}]
...
def get_class_cards(user_email):
    ...
    [{'class_name': "Madhav's Hindi Class", 'classid': '03neblduab6u0fm', 'class_standard': '12 B', 'teacher': 'Madhav Agrawal'}, {'class_name': "Madhav's Hindi Class", 'classid': '5uzgiwo2uvbobk0', 'class_standard': '12 B', 'teacher': 'Madhav Agrawal'}]
    """
...
def get_participants(classid):
    ...
    {'teacher': {'name' : "Madhav Agrawal' , 'email' = 'madhavagrawal65789@gmail.com'}, 'students': [{'name' : "Naitik Agrawal' , 'email' : 'naitiktoobta@gmail.com'}, {'name' : "Lalit' , 'email' : 'lalit459@gmail.com'}]}
...
def try_del_tables(classid):
    ...
    try:
        ...
        try: 
            dbase5.query(f"""DELETE FROM `basic_information` WHERE `basic_information`.`class_id` = '{classid}'""")
        except Exception:
            pass
...
def create_new_class(user_email , class_name , name , class_standard , description):
    ...
    There is a main reason behind these algo as we will do all the tasks before adding entry to the joined_classes. Because if consider there can be a server problem between the whole process. So if entry is added to joined classes but the four tables are not constructed successfully then it will show that the teacher has created this class and he/she can also enter the class. Then there will be problem. So by considering this probelm we have used this algo... 
...
def get_join_req(classid):
    ...
    [{'email': 'agrawalmadhav13@gmail.com', 'name': 'Madhav Agrawal'} ,{'email': 'Naitik1789@gmail.com', 'name': 'Naitik'}]
...
if __name__ == "__main__":
    ...
    # print(add_joining_req("agrawalmadhav13@gmail.com" , "Madhav" , "m9onafx70xtigwc"))
    
    # print(create_new_class("agrawalmadhav13@gmail.com" , "Madhav's Maths Class" , "Madhav Agrawal" , "6 A"))

    # print(get_more_info_classes("agrawalmadhav13@gmail.com"))
    
    # print( add_joining_req("agrawalmadhav12gmail.com" , "Madhav" , "fdjxfc9n9w8uo6c" , "Plz Add!" , "10 B "))

    # print(get_class_cards("agrawalmadhav13@gmail.com"))
    ...
    # print(approve_request("agrawalmadhav132gmail.com" , "fdjxfc9n9w8uo6c"))
    # print(get_class_name("fdjxfc9n9w8uo6c"))
    # print(approve_request("agrawalmadhav13542@gmail.com","oodc5ij3ufw74sp"))

    # print(decline_request("fdjxfc9n9w8uo6c" , "agrawalmadhav12gmail.com" ))
