...
SQLALCHEMY_BINDS = {
    'media_files':        'mysql://root:mainhoondon@localhost/media_Files',
    'users':        'mysql://root:mainhoondon@localhost/users'
}
...
def index():
    if current_user.is_authenticated:
        ...
        return render_template("home.html" , class_cards = class_cards , nav_classes = get_nav_classes(current_user))
